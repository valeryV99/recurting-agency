...
export class CreateCandidateDto {
  @ApiProperty({
    ...
    description: 'The href of the candidate photo',
  })
  @IsString()
  photo: string;
  ...
  @ApiProperty({
    example: 'Ivanovich',
    description: 'The patronymic of the candidate',
  })
  @IsString()
  patronymic: string;
  ...
  @ApiProperty({
    ...
    description: 'The residence Address of the candidate',
  })
  @IsString()
  ...
  @ApiProperty({
    example: '123e4567-e89b-12d3-a456-426614174000',
    description: 'The id of possible position',
  })
  @IsString()
  ...
  @ApiProperty({
    ...
    description: 'The status of condidate step interview',
  })
  @IsString()
  status: string;
}
